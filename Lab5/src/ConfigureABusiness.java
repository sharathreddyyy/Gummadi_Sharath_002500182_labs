...
// Create User accounts that link to specific profiles
        ...
        Person person010 = persondirectory.newPerson("Sharath Reddy");
        FacultyProfile facultyProfile = facultydirectory.newFacultyProfile(person010);
        UserAccount ua5 = uadirectory.newUserAccount(facultyProfile, "Sharath", "****");
