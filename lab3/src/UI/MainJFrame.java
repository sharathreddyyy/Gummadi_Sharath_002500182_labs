...
import static Model.Account.newAccount;
import Model.AccountDirectory;
import UI.AcccountManager.AccountMngWorkAreaJPanel;
...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void btnAccountMngActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAccountMngActionPerformed
        ...
        AccountMngWorkAreaJPanel panel;
        panel = new AccountMngWorkAreaJPanel(userProcessContainer, accountDirectory);
    ...
    private void generateDemoData() {
        ...
        newAccount.setAccountNumber("9999911111");
        newAccount.setRountingNumber("0135792468");
        newAccount.setBankName("Chase Bank");
        newAccount.setBalance(100000);
        
        Account anotherNewAccount = accountDirectory.addAccount();
        anotherNewAccount.setAccountNumber("3333355555");
        anotherNewAccount.setRountingNumber("0246813579");
        anotherNewAccount.setBankName("Bank of America");
        anotherNewAccount.setBalance(200000);              
